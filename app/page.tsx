...
export default function Home() {
  return (
    <div className="p-10 pt-0 text-center md:text-left">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:gird-cols-3 lg:grid-cols-4 xl:grid-cols-5 justify-center items-center gap-5 mt-5">
        {
          // map through search and display them
          SEARCH.map((search) => (
            <Link
              prefetch={false}
              key={search.id}
